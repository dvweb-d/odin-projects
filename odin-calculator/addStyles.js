const bodyClass = 'bg-pink-800 bg-gradient-to-br from-blue-400 bg-opacity-25';
const bdy = document.querySelector('body');
bodyClass.split(' ').forEach((cls) => bdy.classList.add(cls));

const calcBodyClass =
  'max-w-lg rounded overflow-hidden shadow-2xl bg-gray-700 bg-opacity-75 bg-gradient-to-tr from-gray-800 flex';
